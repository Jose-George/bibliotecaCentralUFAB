...
public class Aluno {
	...
	public Aluno(String nome, String nomeMae, String matricula, String cpf, String rg, String naturalidade,
			String endereco, String telefone, String email, String senha, Curso curso, int anoIngresso,
			String periodoInrgresso) {
		super();
		this.nome = nome;
